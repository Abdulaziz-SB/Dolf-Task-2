...
<header  class='h-auto'>
    <nav class='h-20 p-8 flex justify-between items-center'>
        ...
        <ul class='flex justify-evenly items-center w-1/3'>
            ...
            <?php if(isset($_SESSION['usersId'])) :?>
                <li class='text-gray-600'><?php echo explode(" ",$_SESSION['usersName'])[0]; ?></li>  
            ...
            <?php else:?>
                ...
                <a href="./sign-up.php"><li class='text-gray-600 border-2 rounded p-2 px-4 border-primary-200 hover:border-primary-500
                hover:text-gray-900'>
                Sign up</li></a>
            <?php endif;?>
        </ul>
